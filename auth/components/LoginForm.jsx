...
import { loginWithEmailAndPassword, signInWithGoogle, signInWithGithub, 
  signInWithApple, signInWithMicrosoft, signInWithFacebook, resetPassword } from '../utils/firebase';
  ...
  return (
    <div className="auth-card">
      <div className="auth-header">
        ...
        <p className="text-dark-400 dark:text-light-600 mt-2">Sign in to your account</p>
      </div>
      ...
      {resetSent && (
        <div className="bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400 p-3 rounded-xl mb-4">
