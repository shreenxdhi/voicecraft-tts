...
const LoginPage = () => {
  ...
  // Don't show login page if already authenticated or checking auth
  if (loading || user) {
    return (
  ...
  return (
    <>
      <Head>
        <title>Sign In | VoiceCraft</title>
        <meta name="description" content="Sign in to your VoiceCraft account" />
      </Head>
